...
// ── Slot mask ─────────────────────────────────────────────────────────────────
// Only slots with their bit set are treated as active.
// Unset slots are forced OFFLINE regardless of line state.
// Default 0xFFFF = all 16 slots active.
// Blue Pill (no PB2/BOOT1): use 0x001B (bits 0,1,3,4).
