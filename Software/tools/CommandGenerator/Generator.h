...
private:
  ...
  generateTelemetrySourceIDsContent(const std::vector<json> &allData) {
    ...
    out << "#ifndef SMARTDRIVE_TELEMETRYSOURCEIDS_H\n#define "
           "SMARTDRIVE_TELEMETRYSOURCEIDS_H\n\n";
    out << "#include \"opx/shared/core/platform.h\"\n\n";
  ...
  generateDeviceManifestContent(const std::vector<json> &allData) {
    ...
    out << "// device/command menus at runtime without needing compile-time "
           "type knowledge.\n";
    out << "//\n\n";
    out << "#ifndef SMARTDRIVE_DEVICEMANIFEST_H\n";
    out << "#define SMARTDRIVE_DEVICEMANIFEST_H\n\n";
    out << "#ifndef EMBEDDED_BUILD\n\n";
    out << "#include <cstdint>\n";
    out << "#include <vector>\n";
    out << "#include <string>\n";
    ...
    out << "}\n\n";
    out << "#endif // EMBEDDED_BUILD\n\n";
    out << "#endif // SMARTDRIVE_DEVICEMANIFEST_H\n";
