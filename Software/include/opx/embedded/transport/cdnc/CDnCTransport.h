...
public:
  explicit CDnCTransport(uint8_t slaveIndex) : _slaveIndex(slaveIndex) {
    resetParser();
  }
  ...
  bool hasCompleteFrame() const override { return _frameReady; }

  RawData getFrame() override { return RawData{_frameBuf, _framePos}; }
...
private:
  ...
  uint8_t minFrameSize() const {
    ...
    case ProtocolConstants::FrameType::RESPONSE:
      return MIN_RESPONSE_FRAME;
    default:
      return MIN_OTHER_FRAME;
    }
  }
